...
audit}: given a specification \Sig and a trace $T$, a checker decides
$T \entails \Sig$ in $O(|T|\cdot|C|)$ without access to the model or
its prompts. SARC stops at the loop: its reference artifact keeps \Sig
