...
RDF under git with merge strategies, including a Context Merge that reconciles
by node overlap; TerminusDB offers diff and patch over a versioned graph; RDF
