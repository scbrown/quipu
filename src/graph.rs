...
// (Personalized) PageRank — config and kernel — lives in `pagerank` (size
// ratchet split); public paths stay `graph::PageRankConfig` / `graph::page_rank`.
pub use pagerank::{PageRankConfig, page_rank};
